<div class="container_support support">
    ...
    <div class="block-show-rules">
        <p id="title-main-targer-support-rules">Правила сервиса <sub>﹀</sub></p>
    </div>
    <div class="block-support-info-rules">
        ...
        Список правил в дальнейшем может пополнятся.
    </div>
    
    <div class="block-show-current-support-my-page">
    ...
    <div class="block-show-current-support-fav">
        <p id="title-main-targer-support-up">О разделе «Избранное» <sub>﹀</sub></p>
    </div>
    ...
    <div class="block-show-current-support-req">
