                ...
                <?
                    ...
                    }else
                    {
                        ...
                        do{
                            ...
                            $res_check_req = mysql_query("SELECT * FROM responses WHERE (order_id=".$current_order_id.") AND (kind='yes')");
                        ...
                        if (($current_orders_count_after == 0) || ($count_resp_orders==0))
                        {
                            echo '<hr /><p class="not-order">Список текущих заказов пуст</p>';
                        }
                                ...
                                <div class="right-part-review-list-about-user">
                                    ...
                                    echo '<p class="review-text">'.$row_result_current_fav_user_reviews["review_text"].'</p>
                                                        ...
                                                        <fieldset class="rating_current_review" disabled>
                                                            <input type="radio" id="star5'.$row_result_current_fav_user_reviews["author_id"].'" name="user_rating'.$row_result_current_fav_user_reviews["author_id"].'-'.$row_result_current_fav_user_reviews["review_id"].'" value="5" '; if($row_result_current_fav_user_reviews["review_mark"] == 5) { echo "checked"; } echo ' /><label for="star5'.$row_result_current_fav_user_reviews["author_id"].'" title="Отлично!">5 stars</label>
                                                            <input type="radio" id="star4'.$row_result_current_fav_user_reviews["author_id"].'" name="user_rating'.$row_result_current_fav_user_reviews["author_id"].'-'.$row_result_current_fav_user_reviews["review_id"].'" value="4" '; if($row_result_current_fav_user_reviews["review_mark"] == 4) { echo "checked"; } echo ' /><label for="star4'.$row_result_current_fav_user_reviews["author_id"].'" title="Хорошо">4 stars</label>
                                                            <input type="radio" id="star3'.$row_result_current_fav_user_reviews["author_id"].'" name="user_rating'.$row_result_current_fav_user_reviews["author_id"].'-'.$row_result_current_fav_user_reviews["review_id"].'" value="3" '; if($row_result_current_fav_user_reviews["review_mark"] == 3) { echo "checked"; } echo ' /><label for="star3'.$row_result_current_fav_user_reviews["author_id"].'" title="Неплохо">3 stars</label>
                                                            <input type="radio" id="star2'.$row_result_current_fav_user_reviews["author_id"].'" name="user_rating'.$row_result_current_fav_user_reviews["author_id"].'-'.$row_result_current_fav_user_reviews["review_id"].'" value="2" '; if($row_result_current_fav_user_reviews["review_mark"] == 2) { echo "checked"; } echo ' /><label for="star2'.$row_result_current_fav_user_reviews["author_id"].'" title="Плохо">2 stars</label>
                                                            <input type="radio" id="star1'.$row_result_current_fav_user_reviews["author_id"].'" name="user_rating'.$row_result_current_fav_user_reviews["author_id"].'-'.$row_result_current_fav_user_reviews["review_id"].'" value="1" '; if($row_result_current_fav_user_reviews["review_mark"] == 1) { echo "checked"; } echo ' /><label for="star1'.$row_result_current_fav_user_reviews["author_id"].'" title="Ужасно!">1 star</label>
                                                        </fieldset>
                                </div>
                                <div class="clear"></div>
                            </div>';
