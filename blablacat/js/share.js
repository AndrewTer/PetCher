    ...
    $(function()
    {
        $('div.shareinit').each(function(idx)
        {
            ...
            function fb_count(url)
            {
                ...
                {
                    shares=data.share.share_count||0;if(shares>0||z==1)el.find('a[data-count="fb"]').after('<span class="share-counter">'+shares+'</span>')
                })
            }
            fb_count(u);
            function odkl_count(url)
            {
                ...
                {
                    if(shares>0||z==1)$('div.shareinit').eq(idx).find('a[data-count="odkl"]').after('<span class="share42-counter">'+shares+'</span>')
                }
            }odkl_count(u);function vk_count(url)
            {
                $.getScript('//vk.com/share.php?act=count&index='+idx+'&url='+url);
                if(!window.VK)window.VK={};window.VK.Share=
                {
            ...
            var l='';
            for(j=0;j<s.length;j++)l+='<span class="share-item" style="display:inline-block;margin:0 6px 6px 0;height:32px;"><a rel="nofollow" style="display:inline-block;width:32px;height:32px;margin:0;padding:0;outline:none;background:url('+f+fn+') -'+32*j+'px 0 no-repeat" href='+s[j]+' target="_blank"></a></span>';
            el.html('<span id="share">'+l+'</span>'+'<style>.share-counter{display:inline-block;vertical-align:top;margin-left:9px;position:relative;background:#FFF;color:#666;} .share-counter:before{content:"";position:absolute;top:0;left:-8px;width:8px;height:100%;} .share-counter{padding:0 8px 0 4px;font:14px/32px Arial,sans-serif;background:url(data:image/png;base64,) 100% 0;} .share-counter:before{background:url(data:image/png;base64,)}</style>');
        })
    })
})(jQuery);