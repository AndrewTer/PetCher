                                            ...
                                            <div class="current-review">
                                                    ...
                                                    <div class="right-part-review-list">
                                                        ...
                                                        <fieldset class="rating_current_review" disabled>
                                                            <input type="radio" id="star5" name="rating'.$row_result_reviews["sitter_id"].'" value="5" '; if($row_result_reviews["review_mark"] == 5) { echo "checked"; } echo ' /><label for="star5" title="Отлично!">5 stars</label>
                                                            <input type="radio" id="star4" name="rating'.$row_result_reviews["sitter_id"].'" value="4" '; if($row_result_reviews["review_mark"] == 4) { echo "checked"; } echo ' /><label for="star4" title="Хорошо">4 stars</label>
                                                            <input type="radio" id="star3" name="rating'.$row_result_reviews["sitter_id"].'" value="3" '; if($row_result_reviews["review_mark"] == 3) { echo "checked"; } echo ' /><label for="star3" title="Неплохо">3 stars</label>
                                                            <input type="radio" id="star2" name="rating'.$row_result_reviews["sitter_id"].'" value="2" '; if($row_result_reviews["review_mark"] == 2) { echo "checked"; } echo ' /><label for="star2" title="Плохо">2 stars</label>
                                                            <input type="radio" id="star1" name="rating'.$row_result_reviews["sitter_id"].'" value="1" '; if($row_result_reviews["review_mark"] == 1) { echo "checked"; } echo ' /><label for="star1" title="Ужасно!">1 star</label>
                                                        </fieldset>
                                                    </div>
                                                    <div class="clear"></div>
                                            </div>
                                        ...
                                        echo '
                                            ...
                                            <div class="current-review">
                                                  ...
                                                  echo '<p class="review-text">'.$row_result_reviews["review_text"].'</p>
                                                        ...
                                                        <fieldset class="rating_current_review" disabled>
                                                            <input type="radio" id="star5" name="rating'.$row_result_reviews["author_id"].'" value="5" '; if($row_result_reviews["review_mark"] == 5) { echo "checked"; } echo ' /><label for="star5" title="Отлично!">5 stars</label>
                                                            <input type="radio" id="star4" name="rating'.$row_result_reviews["author_id"].'" value="4" '; if($row_result_reviews["review_mark"] == 4) { echo "checked"; } echo ' /><label for="star4" title="Хорошо">4 stars</label>
                                                            <input type="radio" id="star3" name="rating'.$row_result_reviews["author_id"].'" value="3" '; if($row_result_reviews["review_mark"] == 3) { echo "checked"; } echo ' /><label for="star3" title="Неплохо">3 stars</label>
                                                            <input type="radio" id="star2" name="rating'.$row_result_reviews["author_id"].'" value="2" '; if($row_result_reviews["review_mark"] == 2) { echo "checked"; } echo ' /><label for="star2" title="Плохо">2 stars</label>
                                                            <input type="radio" id="star1" name="rating'.$row_result_reviews["author_id"].'" value="1" '; if($row_result_reviews["review_mark"] == 1) { echo "checked"; } echo ' /><label for="star1" title="Ужасно!">1 star</label>
                                                        </fieldset>
                                                    </div>
                                                    <div class="clear"></div>
                                            </div>
                                        ...
                                        echo '
                                            ...
                                            <div class="current-review">
                                                    ...
                                                    <div class="right-part-review-list">
                                                        ...
                                                        <p class="review-rating">Моя оценка:</p>
                                                        <fieldset class="rating_current_review" disabled>
                                                            <input type="radio" id="star5" name="rating" value="5" '; if($row_result_reviews["review_mark"] == 5) { echo "checked"; } echo ' /><label for="star5" title="Отлично!">5 stars</label>
                                                            <input type="radio" id="star4" name="rating" value="4" '; if($row_result_reviews["review_mark"] == 4) { echo "checked"; } echo ' /><label for="star4" title="Хорошо">4 stars</label>
                                                            <input type="radio" id="star3" name="rating" value="3" '; if($row_result_reviews["review_mark"] == 3) { echo "checked"; } echo ' /><label for="star3" title="Неплохо">3 stars</label>
                                                            <input type="radio" id="star2" name="rating" value="2" '; if($row_result_reviews["review_mark"] == 2) { echo "checked"; } echo ' /><label for="star2" title="Плохо">2 stars</label>
                                                            <input type="radio" id="star1" name="rating" value="1" '; if($row_result_reviews["review_mark"] == 1) { echo "checked"; } echo ' /><label for="star1" title="Ужасно!">1 star</label>
                                                        </fieldset>
                                                    </div>
                                                    <div class="clear"></div>
                                            </div>
